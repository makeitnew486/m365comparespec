...
| **플랜** | E3·E5·Teams 제외·Teams 단독·Copilot 옵션 9개 카드 + 고객 유형별 추천 |
| **기능** | 27행 전체 기능 매트릭스 (sticky thead) + 33개 앱 카탈로그 (클릭→상세 모달) |
...
**최근 업데이트 2026-05-19** · 자세한 인수인계는 [`docs/HANDOVER.md`](docs/HANDOVER.md), 변경 연대기는 [`CHANGELOG.md`](CHANGELOG.md) 참고
