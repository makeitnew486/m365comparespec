...
| **DocuShare 언급** (제품명·솔루션명) | FBKR 현재 미운영 | 2026-05-19 |
| **Fujifilm 그룹 / 글로벌 R&D / 일본 본사** 언급 | 사용자 명시 제외 ("왜 FBKR" 카드 03 삭제 시) | 2026-05-19 |
| **검증 안 된 자격·등급·실적** (Solutions Partner 등급, 도입사례 N개 등) | 임의 추가 금지 — FBKR이 명시 제공한 자산만 사용 | 2026-05-19 |
